...
{
    //AJAX service request to get the main text
    $.getJSON
    ('./model/data.json',function(jsonObj)
        {
            ...
            $('#x3dModelTitle_sprite').html('<h2>' + jsonObj.pageTextData[5].X3dModelTitle + '</h2><h2></h2>');
            $('#x3dCreationMethod_sprite').html('<p>' + jsonObj.pageTextData[5].X3dCreationMethod + '</p><p></p>');
            ...
            $('#x3dModelTitle_pepper').html('<h2>' + jsonObj.pageTextData[6].X3dModelTitle + '</h2><h2></h2>');
            $('#x3dCreationMethod_pepper').html('<p>' + jsonObj.pageTextData[6].X3dCreationMethod + '</p><p></p>');
